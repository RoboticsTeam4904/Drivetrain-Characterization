...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    CANCoder leftWheelEncoder = new CANCoder(7);
    CANCoder rightWheelEncoder = new CANCoder(6);
    CANCoderConfiguration _canCoderConfiguration = new CANCoderConfiguration();
    leftWheelEncoder.configAllSettings(_canCoderConfiguration);
    rightWheelEncoder.configAllSettings(_canCoderConfiguration);
    leftWheelEncoder.configSensorDirection(true);
    ...
    leftWheelEncoder.configFeedbackCoefficient(encoderConstant, "meters", SensorTimeBase.PerSecond);
    rightWheelEncoder.configFeedbackCoefficient(encoderConstant, "meters", SensorTimeBase.PerSecond);

    leftEncoderPosition = () -> leftWheelEncoder.getPosition();
    leftEncoderRate = () -> leftWheelEncoder.getVelocity();

    rightEncoderPosition = () -> rightWheelEncoder.getPosition();
    rightEncoderRate = () -> rightWheelEncoder.getVelocity();
